...
(function (f) {
    ...
    (function (console, $hx_exports, $global) {
        ...
        promhx_Stream.prototype = $extend(promhx_base_AsyncBase.prototype, {
            ...
            handleEnd: function () {
                if (this._pending) {
                    ...
                    this._end = true;
                    var o;
                    if (this._resolved) o = haxe_ds_Option.Some(this._val);
                    else o = haxe_ds_Option.None;
        ...
        promhx_base_EventLoop.set_nextLoop = function (f) {
            if (promhx_base_EventLoop.nextLoop != null) throw new js__$Boot_HaxeError('nextLoop has already been set');
            else promhx_base_EventLoop.nextLoop = f;
        ...
        promhx_base_EventLoop.continueOnNextLoop = function () {
            if (promhx_base_EventLoop.nextLoop != null) promhx_base_EventLoop.nextLoop(promhx_base_EventLoop.f);
            else setImmediate(promhx_base_EventLoop.f);
        };
        ...
        verb_core_BoundingBox.intervalsOverlap = function (a1, a2, b1, b2, tol) {
            if (tol == null) tol = -1;
            var tol1;
            if (tol < -0.5) tol1 = verb_core_Constants.TOLERANCE;
            else tol1 = tol;
        ...
        var verb_core_NurbsSurfaceData = ($hx_exports.core.NurbsSurfaceData = function (
            degreeU,
            degreeV,
            knotsU,
            knotsV,
        ...
        var verb_core_VolumeData = ($hx_exports.core.VolumeData = function (
            degreeU,
            degreeV,
            degreeW,
            knotsU,
        ...
        var verb_core_CurveCurveIntersection = ($hx_exports.core.CurveCurveIntersection = function (
            point0,
            point1,
            u0,
            u1,
        ...
        var verb_core_CurveSurfaceIntersection = ($hx_exports.core.CurveSurfaceIntersection = function (
            u,
            uv,
            curvePoint,
            surfacePoint,
        ...
        var verb_core_MeshIntersectionPoint = ($hx_exports.core.MeshIntersectionPoint = function (
            uv0,
            uv1,
            point,
            faceIndex0,
        ...
        var verb_core_PolylineMeshIntersection = ($hx_exports.core.PolylineMeshIntersection = function (
            point,
            u,
            uv,
            polylineIndex,
        ...
        var verb_core_SurfaceSurfaceIntersectionPoint = ($hx_exports.core.SurfaceSurfaceIntersectionPoint = function (
            uv0,
            uv1,
            point,
            dist,
        ...
        verb_core_KdTree.prototype = {
            ...
            nearest: function (point, maxNodes, maxDistance) {
                ...
                nearestSearch1 = function (node) {
                    ...
                    while (_g31 < _g21) {
                        var i2 = _g31++;
                        if (i2 == node.dimension) linearPoint[i2] = point[i2];
                        else linearPoint[i2] = node.kdPoint.point[i2];
                    }
                    ...
                    else if (point[dimension] < node.kdPoint.point[dimension]) bestChild = node.left;
                ...
                while (_g5 < maxNodes) {
                    ...
                    if (bestNodes.content[i4].item0 != null)
                        result.push(
                            new verb_core_Pair(bestNodes.content[i4].item0.kdPoint, bestNodes.content[i4].item1),
                        );
                }
                return result;
            },
        ...
        verb_core_LazyCurveBoundingBoxTree.prototype = {
            split: function () {
                ...
                return new verb_core_Pair(
                    new verb_core_LazyCurveBoundingBoxTree(crvs[0], this._knotTol),
                    new verb_core_LazyCurveBoundingBoxTree(crvs[1], this._knotTol),
                );
            },
            boundingBox: function () {
                if (this._boundingBox == null)
                    this._boundingBox = new verb_core_BoundingBox(
                        verb_eval_Eval.dehomogenize1d(this._curve.controlPoints),
                    );
        ...
        verb_core_LazyMeshBoundingBoxTree.prototype = {
            split: function () {
                ...
                return new verb_core_Pair(
                    new verb_core_LazyMeshBoundingBoxTree(this._mesh, l),
                    new verb_core_LazyMeshBoundingBoxTree(this._mesh, r),
                );
            },
            boundingBox: function () {
                if (this._boundingBox == null)
        ...
        verb_core_LazyPolylineBoundingBoxTree.prototype = {
            split: function () {
                ...
                return new verb_core_Pair(
                    new verb_core_LazyPolylineBoundingBoxTree(this._polyline, l),
                    new verb_core_LazyPolylineBoundingBoxTree(this._polyline, r),
                );
            },
            boundingBox: function () {
        ...
        verb_core_LazySurfaceBoundingBoxTree.prototype = {
            split: function () {
                ...
                return new verb_core_Pair(
                    new verb_core_LazySurfaceBoundingBoxTree(srfs[0], !this._splitV, this._knotTolU, this._knotTolV),
                    new verb_core_LazySurfaceBoundingBoxTree(srfs[1], !this._splitV, this._knotTolU, this._knotTolV),
                );
            },
            boundingBox: function () {
                if (this._boundingBox == null) {
            ...
            indivisible: function (tolerance) {
                return (
                    verb_core_Vec.domain(this._surface.knotsV) < this._knotTolV &&
                    verb_core_Vec.domain(this._surface.knotsU) < this._knotTolU
                );
            },
            empty: function () {
                return false;
        ...
        verb_core_Mesh.triangleUVFromPoint = function (mesh, faceIndex, f) {
            ...
            return verb_core_Vec.add(
                verb_core_Vec.mul(a1, uv1),
                verb_core_Vec.add(verb_core_Vec.mul(a2, uv2), verb_core_Vec.mul(a3, uv3)),
            );
        };
        var verb_core_MeshBoundingBoxTree = function (mesh, faceIndices) {
            ...
            var l = verb_core_ArrayExtensions.left($as);
            var r = verb_core_ArrayExtensions.right($as);
            this._children = new verb_core_Pair(
                new verb_core_MeshBoundingBoxTree(mesh, l),
                new verb_core_MeshBoundingBoxTree(mesh, r),
            );
        };
        ...
        verb_core_Minimizer.uncmin = function (f, x0, tol, gradient, maxit) {
            ...
            while (it < maxit) {
                ...
                H1 = verb_core_Mat.sub(
                    verb_core_Mat.add(
                        H1,
                        verb_core_Mat.mul(
                            (ys + verb_core_Vec.dot(y, Hy)) / (ys * ys),
                            verb_core_Minimizer.tensor(s, s),
                        ),
                    ),
                    verb_core_Mat.div(
                        verb_core_Mat.add(verb_core_Minimizer.tensor(Hy, s), verb_core_Minimizer.tensor(s, Hy)),
                        ys,
                    ),
                );
                x0 = x1;
        ...
        verb_core_Minimizer.numericalGradient = function (f, x) {
            ...
            while (_g < n) {
                ...
                while (true) {
                    ...
                    errest = Math.min(
                        verb_core_Vec.max([Math.abs(d1 - J[i1]), Math.abs(d2 - J[i1]), Math.abs(d1 - d2)]) / N,
                        h / N,
                    );
                    if (errest > eps) h /= 16;
                    else break;
        ...
        verb_core_Trig.segmentClosestPoint = function (pt, segpt0, segpt1, u0, u1) {
            ...
            var o2pt = verb_core_Vec.sub(pt, o);
            var do2ptr = verb_core_Vec.dot(o2pt, r);
            if (do2ptr < 0) return { u: u0, pt: segpt0 };
            else if (do2ptr > l) return { u: u1, pt: segpt1 };
        ...
        verb_core_Vec.norm = function (a) {
            ...
            if (norm2 != 0.0) return Math.sqrt(norm2);
            else return norm2;
        };
        ...
        verb_eval_Analyze.isRationalSurfaceClosed = function (surface, uDir) {
            ...
            var cpts;
            if (uDir) cpts = surface.controlPoints;
            else cpts = verb_core_Mat.transpose(surface.controlPoints);
            var _g1 = 0;
            ...
            while (_g1 < _g) {
                ...
                var test =
                    verb_core_Vec.dist(
                        verb_core_ArrayExtensions.first(cpts)[i],
                        verb_core_ArrayExtensions.last(cpts)[i],
                    ) < verb_core_Constants.EPSILON;
        ...
        verb_eval_Analyze.rationalSurfaceClosestParam = function (surface, p) {
            ...
            while (i < maxits) {
                ...
                if (ct[0] < minu)
                    ...
                    else ct = [minu + verb_core_Constants.EPSILON, ct[1]];
                else if (ct[0] > maxu)
                    if (closedu) ct = [minu + (ct[0] - maxu), ct[1]];
                    else ct = [maxu - verb_core_Constants.EPSILON, ct[1]];
                if (ct[1] < minv)
                    if (closedv) ct = [ct[0], maxv - (ct[1] - minv)];
                    else ct = [ct[0], minv + verb_core_Constants.EPSILON];
                else if (ct[1] > maxv)
                    if (closedv) ct = [ct[0], minv + (ct[0] - maxv)];
                    else ct = [ct[0], maxv - verb_core_Constants.EPSILON];
        ...
        verb_eval_Analyze.rationalCurveClosestParam = function (curve, p) {
            ...
            var closed =
                verb_core_Vec.normSquared(
                    verb_core_Vec.sub(curve.controlPoints[0], verb_core_ArrayExtensions.last(curve.controlPoints)),
                ) < verb_core_Constants.EPSILON;
            var cu = u;
            var f = function (u1) {
        ...
        verb_eval_Analyze.rationalCurveParamAtArcLength = function (curve, len, tol, beziers, bezierLengths) {
            ...
            var crvs;
            if (beziers != null) crvs = beziers;
            else crvs = verb_eval_Modify.decomposeCurveIntoBeziers(curve);
            var i = 0;
            var cc = crvs[i];
            var cl = -verb_core_Constants.EPSILON;
            var bezier_lengths;
            if (bezierLengths != null) bezier_lengths = bezierLengths;
            else bezier_lengths = [];
            while (cl < len && i < crvs.length) {
                if (i < bezier_lengths.length) bezier_lengths[i] = bezier_lengths[i];
                else bezier_lengths[i] = verb_eval_Analyze.rationalBezierCurveArcLength(curve);
                cl += bezier_lengths[i];
        ...
        verb_eval_Analyze.rationalBezierCurveParamAtArcLength = function (curve, len, tol, totalLength) {
            ...
            var totalLen;
            if (totalLength != null) totalLen = totalLength;
            else totalLen = verb_eval_Analyze.rationalBezierCurveArcLength(curve);
            ...
            var mid_l = 0.0;
            var tol1;
            if (tol != null) tol1 = tol;
            else tol1 = verb_core_Constants.TOLERANCE * 2;
        ...
        verb_eval_Analyze.rationalCurveArcLength = function (curve, u, gaussDegIncrease) {
            ...
            if (u == null) u = verb_core_ArrayExtensions.last(curve.knots);
            else u = u;
        ...
        verb_eval_Analyze.rationalBezierCurveArcLength = function (curve, u, gaussDegIncrease) {
            if (gaussDegIncrease == null) gaussDegIncrease = 16;
            var u1;
            if (u == null) u1 = verb_core_ArrayExtensions.last(curve.knots);
            else u1 = u;
        ...
        verb_eval_Check.isValidNurbsSurfaceData = function (data) {
            ...
            if (
                !verb_eval_Check.isValidKnotVector(data.knotsU, data.degreeU) ||
                !verb_eval_Check.isValidKnotVector(data.knotsV, data.degreeV)
            )
                throw new js__$Boot_HaxeError(
                    'Invalid knot vector format!  Should begin with degree + 1 repeats and end with degree + 1 repeats!',
                );
        ...
        verb_eval_Divide.surfaceSplit = function (surface, u, useV) {
            ...
            while (_g11 < controlPoints.length) {
                ...
                ++_g11;
                res = verb_eval_Modify.curveKnotRefine(
                    new verb_core_NurbsCurveData(degree, knots, cps),
                    knots_to_insert,
                );
            ...
            if (!useV) {
                ...
                return [
                    new verb_core_NurbsSurfaceData(degree, surface.degreeV, knots0, surface.knotsV.slice(), newpts0),
                    new verb_core_NurbsSurfaceData(degree, surface.degreeV, knots1, surface.knotsV.slice(), newpts1),
                ];
            }
            return [
                new verb_core_NurbsSurfaceData(surface.degreeU, degree, surface.knotsU.slice(), knots0, newpts0),
                new verb_core_NurbsSurfaceData(surface.degreeU, degree, surface.knotsU.slice(), knots1, newpts1),
            ];
        };
        verb_eval_Divide.curveSplit = function (curve, u) {
            ...
            return [
                new verb_core_NurbsCurveData(degree, knots0, cpts0),
                new verb_core_NurbsCurveData(degree, knots1, cpts1),
            ];
        };
        ...
        verb_eval_Divide.rationalCurveByArcLength = function (curve, l) {
            ...
            while (i < crvs.length) {
                ...
                while (lc < runsum + verb_core_Constants.EPSILON) {
                    u = verb_eval_Analyze.rationalBezierCurveParamAtArcLength(
                        crvs[i],
                        lc - runsum1,
                        verb_core_Constants.TOLERANCE,
                        crvlens[i],
                    );
        ...
        verb_eval_Eval.rationalSurfaceDerivatives = function (surface, u, v, numDerivs) {
            ...
            while (_g1 < _g) {
                ...
                while (_g3 < _g2) {
                    ...
                    while (_g5 < _g4) {
                        var j = _g5++;
                        v1 = verb_core_Vec.sub(
                            v1,
                            verb_core_Vec.mul(verb_core_Binomial.get(l, j) * wders[0][j], SKL[k][l - j]),
                        );
                    }
                    var _g51 = 1;
                    var _g41 = k + 1;
                    while (_g51 < _g41) {
                        ...
                        v1 = verb_core_Vec.sub(
                            v1,
                            verb_core_Vec.mul(verb_core_Binomial.get(k, i) * wders[i][0], SKL[k - i][l]),
                        );
                        ...
                        while (_g7 < _g6) {
                            var j1 = _g7++;
                            v2 = verb_core_Vec.add(
                                v2,
                                verb_core_Vec.mul(verb_core_Binomial.get(l, j1) * wders[i][j1], SKL[k - i][l - j1]),
                            );
                        }
        ...
        verb_eval_Eval.rationalCurveDerivatives = function (curve, u, numDerivs) {
            ...
            while (_g1 < _g) {
                ...
                while (_g3 < _g2) {
                    ...
                    v = verb_core_Vec.sub(
                        v,
                        verb_core_Vec.mul(verb_core_Binomial.get(k1, i1) * wders[i1], CK[k1 - i1]),
                    );
                }
        ...
        verb_eval_Eval.surfaceDerivativesGivenNM = function (n, m, surface, u, v, numDerivs) {
            ...
            if (
                !verb_eval_Eval.areValidRelations(degreeU, controlPoints.length, knotsU.length) ||
                !verb_eval_Eval.areValidRelations(degreeV, controlPoints[0].length, knotsV.length)
            )
                throw new js__$Boot_HaxeError('Invalid relations between control points, knot vector, and n');
            var dim = controlPoints[0][0].length;
            var du;
            if (numDerivs < degreeU) du = numDerivs;
            else du = degreeU;
            var dv;
            if (numDerivs < degreeV) dv = numDerivs;
            else dv = degreeV;
            ...
            while (_g1 < _g) {
                ...
                while (_g3 < _g2) {
                    ...
                    while (_g5 < _g4) {
                        var r = _g5++;
                        temp[s] = verb_core_Vec.add(
                            temp[s],
                            verb_core_Vec.mul(
                                uders[k][r],
                                controlPoints[knotSpan_index_u - degreeU + r][knotSpan_index_v - degreeV + s],
                            ),
                        );
                    }
                }
        ...
        verb_eval_Eval.curveDerivativesGivenN = function (n, curve, u, numDerivs) {
            ...
            var du;
            if (numDerivs < degree) du = numDerivs;
            else du = degree;
            ...
            while (_g1 < _g) {
                ...
                while (_g3 < _g2) {
                    var j1 = _g3++;
                    CK[k1] = verb_core_Vec.add(
                        CK[k1],
                        verb_core_Vec.mul(nders[k1][j1], controlPoints[knotSpan_index - degree + j1]),
                    );
                }
            }
            return CK;
        ...
        verb_eval_Eval.curvePointGivenN = function (n, curve, u) {
            ...
            while (_g1 < _g) {
                var j = _g1++;
                position = verb_core_Vec.add(
                    position,
                    verb_core_Vec.mul(basis_values[j], controlPoints[knotSpan_index - degree + j]),
                );
            }
            return position;
        };
        ...
        verb_eval_Eval.volumePointGivenNML = function (volume, n, m, l, u, v, w) {
            if (
                !verb_eval_Eval.areValidRelations(volume.degreeU, volume.controlPoints.length, volume.knotsU.length) ||
                !verb_eval_Eval.areValidRelations(
                    volume.degreeV,
                    volume.controlPoints[0].length,
                    volume.knotsV.length,
                ) ||
                !verb_eval_Eval.areValidRelations(
                    volume.degreeW,
                    volume.controlPoints[0][0].length,
                    volume.knotsW.length,
                )
            )
            ...
            while (_g1 < _g) {
                ...
                while (_g3 < _g2) {
                    ...
                    while (_g5 < _g4) {
                        var k = _g5++;
                        temp = verb_core_Vec.add(
                            temp,
                            verb_core_Vec.mul(u_basis_vals[k], controlPoints[uind + k][vind][wind]),
                        );
                    }
        ...
        verb_eval_Eval.homogenize1d = function (controlPoints, weights) {
            ...
            var ref_pt = [];
            var weights1;
            if (weights != null) weights1 = weights;
            else weights1 = verb_core_Vec.rep(controlPoints.length, 1.0);
            var _g = 0;
            while (_g < rows) {
                var i = _g++;
                var pt = [];
        ...
        verb_eval_Intersect.surfaces = function (surface0, surface1, tol) {
            ...
            var exactPls = resApprox.map(function (pl) {
                return pl.map(function (inter) {
                    return verb_eval_Intersect.surfacesAtPointWithEstimate(
                        surface0,
                        surface1,
                        inter.uv0,
                        inter.uv1,
            ...
            return exactPls.map(function (x) {
                return verb_eval_Make.rationalInterpCurve(
                    x.map(function (y) {
                        return y.point;
                    }),
                    3,
        ...
        verb_eval_Intersect.meshes = function (mesh0, mesh1, bbtree0, bbtree1) {
            ...
            var segments = verb_core_ArrayExtensions.unique(
                bbints
                    .map(function (ids) {
                ...
                function (a, b) {
                    ...
                    return (
                        (d1 < verb_core_Constants.EPSILON && d2 < verb_core_Constants.EPSILON) ||
                        (d3 < verb_core_Constants.EPSILON && d4 < verb_core_Constants.EPSILON)
                    );
                },
            );
        ...
        verb_eval_Intersect.lookupAdjacentSegment = function (segEnd, tree, numResults) {
            var adj = tree
                .nearest(segEnd.point, numResults, verb_core_Constants.EPSILON)
                .filter(function (r) {
        ...
        verb_eval_Intersect.curveAndSurface = function (curve, surface, tol, crvBbTree, srfBbTree) {
            if (tol == null) tol = 1e-3;
            if (crvBbTree != null) crvBbTree = crvBbTree;
            else crvBbTree = new verb_core_LazyCurveBoundingBoxTree(curve);
            if (srfBbTree != null) srfBbTree = srfBbTree;
            else srfBbTree = new verb_core_LazySurfaceBoundingBoxTree(surface);
            var ints = verb_eval_Intersect.boundingBoxTrees(crvBbTree, srfBbTree, tol);
            return verb_core_ArrayExtensions.unique(
                ints
                    .map(function (inter) {
        ...
        verb_eval_Intersect.curveAndSurfaceWithEstimate = function (curve, surface, start_params, tol) {
            ...
            var grad = function (x1) {
                ...
                var drdv = ds[0][1];
                return [
                    2.0 * verb_core_Vec.dot(drdt, r),
                    2.0 * verb_core_Vec.dot(drdu, r),
                    2.0 * verb_core_Vec.dot(drdv, r),
                ];
            };
            var sol_obj = verb_core_Minimizer.uncmin(objective, start_params, tol * tol, grad);
            var $final = sol_obj.solution;
            return new verb_core_CurveSurfaceIntersection(
                $final[0],
                [$final[1], $final[2]],
                verb_eval_Eval.rationalCurvePoint(curve, $final[0]),
                verb_eval_Eval.rationalSurfacePoint(surface, $final[1], $final[2]),
            );
        };
        verb_eval_Intersect.polylineAndMesh = function (polyline, mesh, tol) {
            var res = verb_eval_Intersect.boundingBoxTrees(
                new verb_core_LazyPolylineBoundingBoxTree(polyline),
                new verb_core_LazyMeshBoundingBoxTree(mesh),
                tol,
            );
            var finalResults = [];
            var _g = 0;
            while (_g < res.length) {
                ...
                var inter = verb_eval_Intersect.segmentWithTriangle(
                    polyline.points[polid],
                    polyline.points[polid + 1],
                    mesh.points,
                    mesh.faces[faceid],
                );
        ...
        verb_eval_Intersect.curves = function (curve1, curve2, tolerance) {
            var ints = verb_eval_Intersect.boundingBoxTrees(
                new verb_core_LazyCurveBoundingBoxTree(curve1),
                new verb_core_LazyCurveBoundingBoxTree(curve2),
                0,
            );
            return verb_core_ArrayExtensions.unique(
                ints
                    .map(function (x) {
                        return verb_eval_Intersect.curvesWithEstimate(
                            curve1,
                            curve2,
                            verb_core_ArrayExtensions.first(x.item0.knots),
                            verb_core_ArrayExtensions.first(x.item1.knots),
                            tolerance,
                        );
                    })
                    .filter(function (x1) {
        ...
        verb_eval_Intersect.triangles = function (mesh0, faceIndex0, mesh1, faceIndex1) {
            ...
            var merged = verb_eval_Intersect.mergeTriangleClipIntervals(
                clip1,
                clip2,
                mesh0,
                faceIndex0,
        ...
        verb_eval_Intersect.clipRayInCoplanarTriangle = function (ray, mesh, faceIndex) {
            ...
            var uvd = [
                verb_core_Vec.sub(uvs[1], uvs[0]),
                verb_core_Vec.sub(uvs[2], uvs[1]),
                verb_core_Vec.sub(uvs[0], uvs[2]),
            ];
            ...
            while (_g < 3) {
                ...
                if (minU == null || uray < minU.u)
                    minU = new verb_core_CurveTriPoint(
                        uray,
                        verb_core_Vec.onRay(ray.origin, ray.dir, uray),
                        verb_core_Vec.onRay(uvs[i], uvd[i], useg / l[i]),
                    );
                if (maxU == null || uray > maxU.u)
                    maxU = new verb_core_CurveTriPoint(
                        uray,
                        verb_core_Vec.onRay(ray.origin, ray.dir, uray),
                        verb_core_Vec.onRay(uvs[i], uvd[i], useg / l[i]),
                    );
        ...
        verb_eval_Intersect.mergeTriangleClipIntervals = function (clip1, clip2, mesh1, faceIndex1, mesh2, faceIndex2) {
            if (
                clip2.min.u > clip1.max.u + verb_core_Constants.EPSILON ||
                clip1.min.u > clip2.max.u + verb_core_Constants.EPSILON
            )
                return null;
            var min;
            if (clip1.min.u > clip2.min.u) min = new verb_core_Pair(clip1.min, 0);
            else min = new verb_core_Pair(clip2.min, 1);
            var max;
            if (clip1.max.u < clip2.max.u) max = new verb_core_Pair(clip1.max, 0);
            else max = new verb_core_Pair(clip2.max, 1);
            var res = new verb_core_Interval(
                new verb_core_MeshIntersectionPoint(null, null, min.item0.point, faceIndex1, faceIndex2),
                new verb_core_MeshIntersectionPoint(null, null, max.item0.point, faceIndex1, faceIndex2),
            );
            if (min.item1 == 0) {
        ...
        verb_eval_Intersect.polylines = function (polyline0, polyline1, tol) {
            var res = verb_eval_Intersect.boundingBoxTrees(
                new verb_core_LazyPolylineBoundingBoxTree(polyline0),
                new verb_core_LazyPolylineBoundingBoxTree(polyline1),
                tol,
            );
            var finalResults = [];
            var _g = 0;
            while (_g < res.length) {
                ...
                var inter = verb_eval_Intersect.segments(
                    polyline0.points[polid0],
                    polyline0.points[polid0 + 1],
                    polyline1.points[polid1],
                    polyline1.points[polid1 + 1],
                    tol,
                );
                if (inter == null) continue;
        ...
        verb_eval_Intersect.segmentWithTriangle = function (p0, p1, points, tri) {
            ...
            if (
                s > 1.0 + verb_core_Constants.EPSILON ||
                t > 1.0 + verb_core_Constants.EPSILON ||
                t < -verb_core_Constants.EPSILON ||
                s < -verb_core_Constants.EPSILON ||
                s + t > 1.0 + verb_core_Constants.EPSILON
            )
                return null;
        ...
        verb_eval_Make.rationalTranslationalSurface = function (profile, rail) {
            ...
            while (_g < numSamples) {
                ...
                var crv = verb_eval_Modify.rationalCurveTransform(profile, [
                    [1, 0, 0, pt[0]],
                    [0, 1, 0, pt[1]],
                    [0, 0, 1, pt[2]],
                    [0, 0, 0, 1],
        ...
        verb_eval_Make.surfaceIsocurve = function (surface, u, useV) {
            if (useV == null) useV = false;
            var knots;
            if (useV) knots = surface.knotsV;
            else knots = surface.knotsU;
            var degree;
            if (useV) degree = surface.degreeV;
            else degree = surface.degreeU;
            ...
            if (Math.abs(u - verb_core_ArrayExtensions.first(knots)) < verb_core_Constants.EPSILON) span = 0;
            ...
            if (useV)
                return new verb_core_NurbsCurveData(
                    newSrf.degreeU,
                    newSrf.knotsU,
                    (function ($this) {
                        var $r;
        ...
        verb_eval_Make.clonedCurve = function (curve) {
            return new verb_core_NurbsCurveData(
                curve.degree,
                curve.knots.slice(),
                curve.controlPoints.map(function (x) {
                    return x.slice();
                }),
            );
        };
        ...
        verb_eval_Make.ellipseArc = function (center, xaxis, yaxis, startAngle, endAngle) {
            ...
            var numArcs = 0;
            if (theta <= Math.PI / 2) numArcs = 1;
            else if (theta <= Math.PI) numArcs = 2;
            else if (theta <= (3 * Math.PI) / 2) numArcs = 3;
            else numArcs = 4;
            var dtheta = theta / numArcs;
            var n = 2 * numArcs;
            var w1 = Math.cos(dtheta / 2);
            var P0 = verb_core_Vec.add(
                center,
                verb_core_Vec.add(
                    verb_core_Vec.mul(xradius * Math.cos(startAngle), xaxis),
                    verb_core_Vec.mul(yradius * Math.sin(startAngle), yaxis),
                ),
            );
            var T0 = verb_core_Vec.sub(
                verb_core_Vec.mul(Math.cos(startAngle), yaxis),
                verb_core_Vec.mul(Math.sin(startAngle), xaxis),
            );
            var controlPoints = [];
            ...
            while (_g1 < _g) {
                var i = _g1++;
                angle += dtheta;
                var P2 = verb_core_Vec.add(
                    center,
                    verb_core_Vec.add(
                        verb_core_Vec.mul(xradius * Math.cos(angle), xaxis),
                        verb_core_Vec.mul(yradius * Math.sin(angle), yaxis),
                    ),
                );
                weights[index + 2] = 1;
                controlPoints[index + 2] = P2;
                var T2 = verb_core_Vec.sub(
                    verb_core_Vec.mul(Math.cos(angle), yaxis),
                    verb_core_Vec.mul(Math.sin(angle), xaxis),
                );
                var inters = verb_eval_Intersect.rays(
                    P0,
                    verb_core_Vec.mul(1 / verb_core_Vec.norm(T0), T0),
                    P2,
                    verb_core_Vec.mul(1 / verb_core_Vec.norm(T2), T2),
                );
        ...
        verb_eval_Make.arc = function (center, xaxis, yaxis, radius, startAngle, endAngle) {
            return verb_eval_Make.ellipseArc(
                center,
                verb_core_Vec.mul(radius, verb_core_Vec.normalized(xaxis)),
                verb_core_Vec.mul(radius, verb_core_Vec.normalized(yaxis)),
                startAngle,
                endAngle,
            );
        };
        ...
        verb_eval_Make.extrudedSurface = function (axis, length, profile) {
            ...
            return new verb_core_NurbsSurfaceData(
                2,
                profile.degree,
                [0, 0, 0, 1, 1, 1],
                profile.knots,
                verb_eval_Eval.homogenize2d(controlPoints, weights),
            );
        };
        ...
        verb_eval_Make.revolvedSurface = function (profile, center, axis, theta) {
            ...
            while (_g11 < _g3) {
                ...
                while (_g31 < _g21) {
                    ...
                    if (r == 0) P2 = O;
                        ...
                        P2 = verb_core_Vec.add(
                            O,
                            verb_core_Vec.add(
                                verb_core_Vec.mul(r * cosines[i2], X),
                                verb_core_Vec.mul(r * sines[i2], Y),
                            ),
                        );
                    ...
                    if (r == 0) controlPoints1[index + 1][j1] = O;
                    else {
                        var inters = verb_eval_Intersect.rays(
                            P0,
                            verb_core_Vec.mul(1 / verb_core_Vec.norm(T0), T0),
            ...
            return new verb_core_NurbsSurfaceData(
                ...
                knotsU,
                profile.knots,
                verb_eval_Eval.homogenize2d(controlPoints1, weights1),
            );
        };
        ...
        verb_eval_Make.conicalSurface = function (axis, xaxis, base, height, radius) {
            ...
            var prof_degree = 1;
            var prof_ctrl_pts = [
                verb_core_Vec.add(base, verb_core_Vec.mul(height, axis)),
                verb_core_Vec.add(base, verb_core_Vec.mul(radius, xaxis)),
            ];
            var prof_knots = [0.0, 0.0, 1.0, 1.0];
            var prof_weights = [1.0, 1.0];
            var prof = new verb_core_NurbsCurveData(
                prof_degree,
                prof_knots,
                verb_eval_Eval.homogenize1d(prof_ctrl_pts, prof_weights),
            );
        ...
        verb_eval_Make.rationalInterpCurve = function (points, degree, homogeneousPoints, start_tangent, end_tangent) {
            ...
            if (points.length < degree + 1)
                throw new js__$Boot_HaxeError(
                    'You need to supply at least degree + 1 points! You only supplied ' + points.length + ' points.',
                );
            var us = [0.0];
            var _g1 = 1;
            ...
            var start;
            if (hasTangents) start = 0;
            else start = 1;
            var end;
            if (hasTangents) end = us.length - degree + 1;
            else end = us.length - degree;
            var _g3 = start;
            while (_g3 < end) {
                var i2 = _g3++;
                var weightSums = 0.0;
            ...
            var A = [];
            var n;
            if (hasTangents) n = points.length + 1;
            else n = points.length - 1;
            var lst;
            if (hasTangents) lst = 1;
            else lst = 0;
            var ld;
            if (hasTangents) ld = points.length - (degree - 1);
            else ld = points.length - (degree + 1);
            var _g4 = 0;
            while (_g4 < us.length) {
                var u = us[_g4];
                ++_g4;
        ...
        verb_eval_Modify.curveReverse = function (curve) {
            return new verb_core_NurbsCurveData(
                curve.degree,
                verb_eval_Modify.knotsReverse(curve.knots),
                verb_core_ArrayExtensions.reversed(curve.controlPoints),
            );
        };
        verb_eval_Modify.surfaceReverse = function (surface, useV) {
            ...
            if (useV)
                return new verb_core_NurbsSurfaceData(
                    ...
                    surface.degreeV,
                    surface.knotsU,
                    verb_eval_Modify.knotsReverse(surface.knotsV),
                    (function ($this) {
                        var $r;
                        var _g = [];
                        {
            ...
            return new verb_core_NurbsSurfaceData(
                surface.degreeU,
                surface.degreeV,
                verb_eval_Modify.knotsReverse(surface.knotsU),
                surface.knotsV,
                verb_core_ArrayExtensions.reversed(surface.controlPoints),
            );
        };
        ...
        verb_eval_Modify.unifyCurveKnotVectors = function (curves) {
            ...
            while (_g11 < curves.length) {
                ...
                ++_g11;
                _g2.push(
                    new verb_core_Interval(
                        verb_core_ArrayExtensions.first(c.knots),
            ...
            while (_g21 < _g12) {
                ...
                curves[i1].knots = curves[i1].knots.map(
                    (function (min) {
                        return function (x4) {
                            return x4 - min[0];
                        };
            ...
            while (_g22 < _g13) {
                ...
                curves[i2].knots = curves[i2].knots.map(
                    (function (scale) {
                        return function (x5) {
                            return x5 * scale[0];
                        };
        ...
        verb_eval_Modify.curveElevateDegree = function (curve, finalDegree) {
            ...
            while (b < m) {
                ...
                var rbz;
                if (r > 0) rbz = Math.floor(ph - (r + 1) / 2);
                else rbz = ph;
                if (r > 0) {
                    var numer = ub - ua;
                    var alfs = [];
                    ...
                    while (_g14 < _g7) {
                        ...
                        var k1 = newDegree;
                        while (k1 >= s) {
                            bpts[k1] = verb_core_Vec.add(
                                verb_core_Vec.mul(alfs[k1 - s], bpts[k1]),
                                verb_core_Vec.mul(1.0 - alfs[k1 - s], bpts[k1 - 1]),
                            );
                            k1--;
                        }
        ...
        verb_eval_Modify.rationalSurfaceTransform = function (surface, mat) {
            ...
            return new verb_core_NurbsSurfaceData(
                surface.degreeU,
                surface.degreeV,
                surface.knotsU.slice(),
                surface.knotsV.slice(),
                verb_eval_Eval.homogenize2d(pts, verb_eval_Eval.weight2d(surface.controlPoints)),
            );
        };
        verb_eval_Modify.rationalCurveTransform = function (curve, mat) {
            ...
            return new verb_core_NurbsCurveData(
                curve.degree,
                curve.knots.slice(),
                verb_eval_Eval.homogenize1d(pts, verb_eval_Eval.weight1d(curve.controlPoints)),
            );
        };
        verb_eval_Modify.surfaceKnotRefine = function (surface, knotsToInsert, useV) {
            ...
            while (_g < ctrlPts.length) {
                ...
                ++_g;
                c = verb_eval_Modify.curveKnotRefine(
                    new verb_core_NurbsCurveData(degree, knots, cptrow),
                    knotsToInsert,
                );
        ...
        verb_eval_Modify.decomposeCurveIntoBeziers = function (curve) {
            ...
            while (_g < knotmults.length) {
                ...
                if (knotmult.mult < reqMult) {
                    ...
                    var res = verb_eval_Modify.curveKnotRefine(
                        new verb_core_NurbsCurveData(degree, knots, controlPoints),
                        knotsInsert,
                    );
                    knots = res.knots;
            ...
            while (j >= 0) {
                ...
                while (_g14 < _g5) {
                    ...
                    if (Math.abs(alfa) < verb_core_Constants.EPSILON)
                        ...
                        controlPoints_post[ind - 1] = verb_core_Vec.add(
                            verb_core_Vec.mul(alfa, controlPoints_post[ind - 1]),
                            verb_core_Vec.mul(1.0 - alfa, controlPoints_post[ind]),
                        );
                    }
                }
        ...
        verb_eval_Modify.curveKnotInsert = function (curve, u, r) {
            ...
            while (_g15 < _g7) {
                ...
                while (_g31 < _g21) {
                    ...
                    controlPoints_temp[i7] = verb_core_Vec.add(
                        verb_core_Vec.mul(alpha, controlPoints_temp[i7 + 1]),
                        verb_core_Vec.mul(1.0 - alpha, controlPoints_temp[i7]),
                    );
                }
        ...
        verb_eval_Tess.rationalCurveRegularSample = function (curve, numSamples, includeU) {
            return verb_eval_Tess.rationalCurveRegularSampleRange(
                curve,
                curve.knots[0],
                verb_core_ArrayExtensions.last(curve.knots),
                numSamples,
                includeU,
            );
        };
        verb_eval_Tess.rationalCurveRegularSampleRange = function (curve, start, end, numSamples, includeU) {
            ...
            while (_g < numSamples) {
                var i = _g++;
                u = start + span * i;
                if (includeU) p.push([u].concat(verb_eval_Eval.rationalCurvePoint(curve, u)));
                else p.push(verb_eval_Eval.rationalCurvePoint(curve, u));
            }
            return p;
        };
        verb_eval_Tess.rationalCurveAdaptiveSample = function (curve, tol, includeU) {
            ...
            if (curve.degree == 1) {
                if (!includeU) return curve.controlPoints.map(verb_eval_Eval.dehomogenize);
                else {
                    var _g = [];
                    var _g2 = 0;
            ...
            return verb_eval_Tess.rationalCurveAdaptiveSampleRange(
                curve,
                curve.knots[0],
                verb_core_ArrayExtensions.last(curve.knots),
                tol,
        ...
        verb_eval_Tess.rationalCurveAdaptiveSampleRange = function (curve, start, end, tol, includeU) {
            ...
            if (
                (verb_core_Vec.dot(diff, diff) < tol && verb_core_Vec.dot(diff2, diff2) > tol) ||
                !verb_core_Trig.threePointsAreFlat(p1, p2, p3, tol)
            ) {
            ...
            } else if (includeU) return [[start].concat(p1), [end].concat(p3)];
            else return [p1, p3];
        };
        ...
        verb_eval_Tess.divideRationalSurfaceAdaptive = function (surface, options) {
            ...
            if (options.minDivsU != null) options.minDivsU = options.minDivsU;
            else options.minDivsU = 1;
            if (options.minDivsV != null) options.minDivsU = options.minDivsV;
            else options.minDivsU = 1;
            if (options.refine != null) options.refine = options.refine;
            else options.refine = true;
            var minU = (surface.controlPoints.length - 1) * 2;
            var minV = (surface.controlPoints[0].length - 1) * 2;
            var divsU;
            if (options.minDivsU > minU) divsU = options.minDivsU = options.minDivsU;
            else divsU = options.minDivsU = minU;
            var divsV;
            if (options.minDivsV > minV) divsV = options.minDivsV = options.minDivsV;
            else divsV = options.minDivsV = minV;
        ...
        verb_eval_Tess.rationalSurfaceAdaptive = function (surface, options) {
            ...
            else options = new verb_eval_AdaptiveRefinementOptions();
        ...
        var verb_eval_AdaptiveRefinementNode = ($hx_exports.core.AdaptiveRefinementNode = function (
            srf,
            corners,
            neighbors,
        ) {
            this.srf = srf;
            if (neighbors == null) this.neighbors = [null, null, null, null];
            else this.neighbors = neighbors;
            ...
            if (this.corners == null) {
                ...
                this.corners = [
                    verb_core_SurfacePoint.fromUv(u0, v0),
                    verb_core_SurfacePoint.fromUv(u1, v0),
                    verb_core_SurfacePoint.fromUv(u1, v1),
                    verb_core_SurfacePoint.fromUv(u0, v1),
                ];
            }
        });
        ...
        verb_eval_AdaptiveRefinementNode.prototype = {
            ...
            center: function () {
                if (this.centerPoint != null) return this.centerPoint;
                else return this.evalSrf(this.u05, this.v05);
            },
            ...
            fixNormals: function () {
                ...
                while (_g < l) {
                    ...
                    if (this.corners[i].degen) {
                        ...
                        if (v1.degen) this.corners[i].normal = v2.normal;
                        else this.corners[i].normal = v1.normal;
                    }
                }
            },
            shouldDivide: function (options, currentDepth) {
                ...
                this.splitVert =
                    verb_core_Vec.normSquared(verb_core_Vec.sub(this.corners[0].normal, this.corners[1].normal)) >
                        options.normTol ||
                    verb_core_Vec.normSquared(verb_core_Vec.sub(this.corners[2].normal, this.corners[3].normal)) >
                        options.normTol;
                this.splitHoriz =
                    verb_core_Vec.normSquared(verb_core_Vec.sub(this.corners[1].normal, this.corners[2].normal)) >
                        options.normTol ||
                    verb_core_Vec.normSquared(verb_core_Vec.sub(this.corners[3].normal, this.corners[0].normal)) >
                        options.normTol;
                if (this.splitVert || this.splitHoriz) return true;
                var center = this.center();
                return (
                    verb_core_Vec.normSquared(verb_core_Vec.sub(center.normal, this.corners[0].normal)) >
                        options.normTol ||
                    verb_core_Vec.normSquared(verb_core_Vec.sub(center.normal, this.corners[1].normal)) >
                        options.normTol ||
                    verb_core_Vec.normSquared(verb_core_Vec.sub(center.normal, this.corners[2].normal)) >
                        options.normTol ||
                    verb_core_Vec.normSquared(verb_core_Vec.sub(center.normal, this.corners[3].normal)) >
                        options.normTol
                );
            },
            ...
            _divide: function (options, currentDepth, horiz) {
                ...
                currentDepth++;
                if (this.splitVert && !this.splitHoriz) horiz = false;
                else if (!this.splitVert && this.splitHoriz) horiz = true;
                ...
                if (this.horizontal) {
                    ...
                    this.children = [
                        new verb_eval_AdaptiveRefinementNode(this.srf, bott),
                        new verb_eval_AdaptiveRefinementNode(this.srf, top),
                    ];
                    this.children[0].neighbors = [
                        this.neighbors[0],
                        this.neighbors[1],
                        this.children[1],
                        this.neighbors[3],
                    ];
                    this.children[1].neighbors = [
                        this.children[0],
                        this.neighbors[1],
                        this.neighbors[2],
                        this.neighbors[3],
                    ...
                    this.children = [
                        new verb_eval_AdaptiveRefinementNode(this.srf, left),
                        new verb_eval_AdaptiveRefinementNode(this.srf, right),
                    ];
                    this.children[0].neighbors = [
                        this.neighbors[0],
                        this.children[1],
        ...
        verb_geom_NurbsCurve.byKnotsControlPointsWeights = function (degree, knots, controlPoints, weights) {
            return new verb_geom_NurbsCurve(
                new verb_core_NurbsCurveData(
                    degree,
                    knots.slice(),
                    verb_eval_Eval.homogenize1d(controlPoints, weights),
                ),
            );
        };
        ...
        verb_geom_NurbsCurve.prototype = $extend(verb_core_SerializableBase.prototype, {
            ...
            asNurbs: function () {
                return new verb_core_NurbsCurveData(
                    this.degree(),
                    this.knots(),
                    verb_eval_Eval.homogenize1d(this.controlPoints(), this.weights()),
                );
            },
            clone: function () {
            ...
            domain: function () {
                return new verb_core_Interval(
                    verb_core_ArrayExtensions.first(this._data.knots),
                    verb_core_ArrayExtensions.last(this._data.knots),
                );
            },
        ...
        verb_geom_NurbsSurface.byKnotsControlPointsWeights = function (
            degreeU,
            degreeV,
            knotsU,
            knotsV,
            ...
            return new verb_geom_NurbsSurface(
                new verb_core_NurbsSurfaceData(
                    degreeU,
                    degreeV,
                    knotsU,
                    knotsV,
        ...
        verb_geom_NurbsSurface.prototype = $extend(verb_core_SerializableBase.prototype, {
            ...
            asNurbs: function () {
                return new verb_core_NurbsSurfaceData(
                    ...
                    this.knotsU(),
                    this.knotsV(),
                    verb_eval_Eval.homogenize2d(this.controlPoints(), this.weights()),
                );
            },
            clone: function () {
            ...
            domainU: function () {
                return new verb_core_Interval(
                    verb_core_ArrayExtensions.first(this._data.knotsU),
                    verb_core_ArrayExtensions.last(this._data.knotsU),
                );
            },
            domainV: function () {
                return new verb_core_Interval(
                    verb_core_ArrayExtensions.first(this._data.knotsV),
        ...
        var verb_geom_CylindricalSurface = ($hx_exports.geom.CylindricalSurface = function (
            axis,
            xaxis,
            base,
            height,
        ...
        var verb_geom_ExtrudedSurface = ($hx_exports.geom.ExtrudedSurface = function (profile, direction) {
            verb_geom_NurbsSurface.call(
                this,
                verb_eval_Make.extrudedSurface(
                    verb_core_Vec.normalized(direction),
                    verb_core_Vec.norm(direction),
                    profile.asNurbs(),
                ),
            );
        ...
        var verb_geom_SweptSurface = ($hx_exports.geom.SweptSurface = function (profile, rail) {
            verb_geom_NurbsSurface.call(
                this,
                verb_eval_Make.rationalTranslationalSurface(profile.asNurbs(), rail.asNurbs()),
            );
            this._profile = profile;
            this._rail = rail;
        });
